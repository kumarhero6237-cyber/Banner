...
async def uncommon_home() -> HTMLResponse:
    ...
    <head>
        ...
        <title>Uncommon Banner API</title>
        <style>
            * {
                margin: 0;
                padding: 0;
    ...
    <body>
        <div class="glass">
            <div class="title">Uncommon Banner API</div>
            ...
            <div class="credits">
                <span>⚜️ Made by <a href="https://t.me/uncommonexe" target="_blank">@uncommonexe</a></span>
                <span class="channel">📢 Channel <a href="https://t.me/uncommoncore" target="_blank">@uncommoncore</a></span>
            </div>
        </div>
...
async def uncommon_get_banner(uid: str) -> Response:
    ...
    if "code" in data and data["code"] != 0:
        ...
        raise HTTPException(404, f"API Error: {error_msg}")
